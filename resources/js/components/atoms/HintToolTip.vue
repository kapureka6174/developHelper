<template>
    <div class="flex flex-col items-center justify-center relative ml-2">
        <div
            class="
                bg-blue-500
                text-blue-600 text-center text-xs
                rounded-lg
                py-2
                mb-2
                px-3
    ...
    setup() {
        ...
        const getMessage = (type) => {
            ...
            switch (type) {
                ...
                case "ページ":
                    message =
                        "サービスで使用するページを設定してください。<br>例）ページ名：新規登録画面、マイページ<br>要件定義で機能を設定すると選択できます。";
                    break;
                case "URI設計":
                    message =
