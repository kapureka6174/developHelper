<template>
    <div>
        ...
        >
            <template #title> APIトークン </template>

            <template #content>
                <div>
                    新しいAPIトークンをコピーしてください。安全のため、二度と表示されません。
                </div>
        ...
        >
            <template #title> APIトークン認可 </template>
        ...
        >
            <template #title> APIトークン削除 </template>

            <template #content> APIトークンを削除しますか？ </template>
